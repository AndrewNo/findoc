                ...
                <div class="modal-container">
                    ...
                    <div class="modal-body">
                        <form action="income/add" method="post">
                            ...
                            <input type="number" step="0.01" id="total_sum" required name="total_sum"><span>KKK</span>
                            <label for="category_id">Category:</label>
                            <select name="category_id" id="category_id">

                                <option value="" disabled="disabled" selected>Choose category</option>
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" data-category-pic="{{ $category->pic }}">{{ $category->title }}</option>
                                @endforeach
